...
function renderIcnFrame1(data: data.Stream, w: number, h: number): Uint8Array {
...
function renderIcnFrame2(data: data.Stream, w: number, h: number): Uint8Array {
  var buf = new Uint8Array(w * h);
  var x = 0;
  var y = 0;
  for (; ;) {
...
export function create(data: data.Stream): IcnFile {
